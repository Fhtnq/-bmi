...
#1、设置升高标签和输入框
#1-1身高标签
label_height = tkinter.Label(tk,text = '身高',font = ('楷书',20))
...
#1-3身高单位
label_cm = tkinter.Label(tk,text = 'cm',font = ('楷书',20))
label_cm.place(x = 170,y = 10,width = 40,height = 40)

#2、设置体重标签和输入框
#2-1体重标签
label_weight = tkinter.Label(tk,text = '体重',font = ('楷书',20))
...
#2-3体重单位kg
label_kg = tkinter.Label(tk,text = 'kg',font = ('楷书',20))
...
button_bmi = tkinter.Button(tk,text = 'BMI',font = ('楷书',20),command = bmi)
button_bmi.place(x = 50,y = 110,width = 300,height = 40)
#添加显示结果的输入框
entry_bmi1=tkinter.Entry(tk,textvariable = Bmi1,font=('楷书',20))
entry_bmi1.place(x = 30,y = 160,width = 340,height = 50)
entry_bmi2=tkinter.Entry(tk,textvariable = Bmi2,font=('楷书',20))
